...
canvas.drawArc(105, 160, 49, 10, 120, 170);
 canvas.drawArc(100, 100, 89, 60, 350, 100);
 canvas.drawArc(128, 60, 89, 50, 180, 25);
 canvas.drawArc(135, 80, 89, 50, 120, 38);
 canvas.drawArc(135, 110, 15, 80, 330, 120);
 canvas.drawArc(100, 100, 89, 67, 110, 58);
 canvas.drawArc(125, 104, 19, 150, 110, 58);
 canvas.drawArc(128, 60, 89, 50, 180, 25);
 
// Отрисовываем дугу по середине овала
            //рисуем два мелньких круга сверху и снизу
            canvas.drawOval(129, 95, 17, 15);
          
            //устанавливаем стиль и пишим текст
            canvas.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 40));
            canvas.drawString("NDD-8", 75, 50);

            try {
                // При помощи созданной функции заливки закрашиваем две части главного овала
                // и два маленьких кружка
                fill(110, 110, Color.GRAY, Color.blue);
                fill(150, 110, Color.GRAY, Color.blue);
                fill(130, 130, Color.GRAY, Color.RED);
                fill(130, 90, Color.GRAY, Color.YELLOW);
                fill(130, 101, Color.GRAY, Color.ORANGE);
                fill(110, 120, Color.GRAY, Color.CYAN);
                fill(170, 100, Color.GRAY, Color.CYAN);
       fill(115, 165, Color.GRAY, Color.black);
